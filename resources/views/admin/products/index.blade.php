...
@section('content')
    ...
    >
                        ...
                        @forelse($products as $product)
                            <tr class="transition hover:bg-gray-50">
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    @if ($product->stock)
                                        <span
                                            class="{{ $product->stock < 10 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }} inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold"
                                        >
                    ...
                    <div class="mb-6 rounded-xl border border-red-200 bg-red-50 p-4">
                        ...
                        <div class="rounded-lg border border-red-200 bg-white p-3">
                            <p
                                ...
                                x-text="deleteModal.productName"
                            ></p>
                            <p class="text-sm text-gray-600">ID: #<span x-text="deleteModal.productId"></span></p>
                        </div>
                    </div>
        ...
        <form
            :action="`{{ route('admin.products.index') }}/${deleteModal.productId}`"
            method="POST"
            x-ref="deleteForm"
        >
            @csrf
            ...
            function productManager() {
                return {
                    ...
                    confirmDelete(productId, productName) {
                        this.deleteModal.productId = productId;
                        this.deleteModal.productName = productName;
