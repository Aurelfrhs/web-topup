                            ...
                            <tr class="transition hover:bg-gray-50">
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    <div class="text-xs text-gray-500 line-through">
                                        Rp {{ number_format($flashSale->product->price ?? 0, 0, ',', '.') }}
                                    </div>
                            ...
                            <tr>
                                ...
                                >
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="mb-2 text-lg font-semibold text-gray-900">Belum ada flash sale</h3>
                                        <p class="mb-4 text-sm text-gray-500">Mulai tambahkan flash sale untuk meningkatkan
                                            penjualan</p>
                                        <a
                                            href="{{ route('admin.flash-sales.create') }}"
